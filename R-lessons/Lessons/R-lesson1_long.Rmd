...
R works on things called 'objects'. An object is anything saved in R that has a name and some information associated with that name. Today we will learn how to make and manipulate several kinds (i.e. *classes*) of objects: vectors, matrices, arrays, dataframes, and lists.
